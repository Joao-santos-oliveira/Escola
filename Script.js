function botao(){
    ...
    else if (nome.value==='Luz'){
        img.innerHTML = '<img src="../Luz.jpg" class="imagens">'
        oi.innerHTML = 'Materias necessários:'
        oi2.innerHTML = 'Laser; Garrafa pet e Canudinho'
        oi3.innerHTML = 'Como fazer:'
        oi4.innerHTML = 'Faça um furo na garrafa do mesmo diâmetro do canudinho, após isso cole o canudinho na garrafa e deixe ele todo por fora da garrafa. Feito isso, apague a luz e jogue o laser dentro do fluxo da água'
        oi5.innerHTML = 'Explicação Científica:'
        oi10.innerHTML = 'Aluz segue a curvatura da trajetória da água fazendo um zigue zague refletindo completamente quando chega na divisa entre a água e o ar voltando para dentro da água batendo na outra parede da água refletindo completamente mais uma vez voltando para dentro e fazendo um caminho em zigue zague seguindo a trajetória curva da água'
        oi7.innerHTML = 'Feito por:'
        oi8.innerHTML =  'Lucas, Inácio e Davi'   
    }
    else if (nome.value==='Luz '){
        img.innerHTML = '<img src="../Luz.jpg" class="imagens">'
        oi.innerHTML = 'Materias necessários:'
